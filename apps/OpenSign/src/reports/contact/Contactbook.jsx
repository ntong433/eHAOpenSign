...
const Contactbook = (props) => {
  ...
  const handleActionBtn = withSessionValidation(async (act, item) => {
    // Actions disabled for synchronized contacts
  });
  // Get current list
      ...
      <div className="p-2 w-full bg-base-100 text-base-content op-card shadow-lg">
        ...
        >
          ...
          <div className="flex flex-row justify-center items-center gap-3 mb-2">
            ...
            {/* Action buttons removed for synchronized contacts */}
                ...
                currentList.map((item, index) => (
                  <tr className="last:border-none border-y-[1px]" key={index}>
                    ...
                    <td className="px-3 py-2">
                      <div className="text-base-content min-w-max flex flex-row gap-x-2 gap-y-1 justify-start items-center text-gray-400 italic text-xs">
                        Managed in Entra ID
                      </div>
                    </td>
                  </tr>
