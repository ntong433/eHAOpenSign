...
import { createEnterpriseApiRouter } from '../../../../custom/api/index.js';
...
// CUSTOM-LAYER: mount enterprise routes from the isolated root custom layer.
app.use('/enterprise', createEnterpriseApiRouter(express));
