    ...
    if (docId && isReceipents) {
      ...
      try {
        ...
        for (let i = 0; i < recipients.length; i++) {
          const logo = `<div style='padding:20px;font-family:system-ui;font-weight:700;color:#ED3237'>Life Helpers Initiative</div>`;
          ...
          let params = {
            ...
            html:
              ...
              `</div></div><div><p>This is an automated email from ${TenantAppName}. For assistance, contact helpdesk@lhinigeria.org.</p></div></div></body></html>`,
          };
